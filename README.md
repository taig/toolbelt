...
```scala
libraryDependencies ++=
    "io.taig.android" %% "toolbelt-compatibility" % "0.8.2" ::
    "io.taig.android" %% "toolbelt-functional" % "0.8.2" ::
    "io.taig.android" %% "toolbelt-graphic" % "0.8.2" ::
    "io.taig.android" %% "toolbelt-intent" % "0.8.2" ::
    "io.taig.android" %% "toolbelt-log" % "0.8.2" ::
    "io.taig.android" %% "toolbelt-mosby" % "0.8.2" ::
    "io.taig.android" %% "toolbelt-system-service" % "0.8.2" ::
    "io.taig.android" %% "toolbelt-unit" % "0.8.2" ::
    "io.taig.android" %% "toolbelt-util" % "0.8.2" ::
    "io.taig.android" %% "toolbelt-context" % "0.8.2" ::
    "io.taig.android" %% "toolbelt-widget" % "0.8.2" ::
    "io.taig.android" %% "toolbelt-concurrent" % "0.8.2" ::
    "io.taig.android" %% "toolbelt-resource" % "0.8.2" ::
    "io.taig.android" %% "toolbelt-app" % "0.8.2" ::
    Nil

libraryDependencies += "io.taig.android" %% "toolbelt" % "0.8.2"
```

```
io.taig.android:toolbelt_2.11:0.8.2 [S]
  +-io.taig.android:toolbelt-app_2.11:0.8.2 [S]
  ...
  | |     +-com.android.support:support-annotations:25.2.0
  | |     
  | +-io.taig.android:toolbelt-context_2.11:0.8.2 [S]
  | | +-io.taig.android:toolbelt-log_2.11:0.8.2 [S]
  | |
  | +-io.taig.android:toolbelt-log_2.11:0.8.2 [S]
  | +-io.taig.android:toolbelt-system-service_2.11:0.8.2 [S]
  |
  +-io.taig.android:toolbelt-compatibility:0.8.2
  | +-com.android.support:support-v4:25.2.0
  |   +-com.android.support:support-compat:25.2.0
  ...
  |       +-com.android.support:support-annotations:25.2.0
  |       
  +-io.taig.android:toolbelt-concurrent_2.11:0.8.2 [S]
  ...
  | | +-io.taig.android:toolbelt-system-service_2.11:0.8.2 [S]
  | |
  | +-io.taig.android:toolbelt-util_2.11:0.8.2 [S]
  |
  +-io.taig.android:toolbelt-context_2.11:0.8.2 [S]
  | +-io.taig.android:toolbelt-log_2.11:0.8.2 [S]
  |
  +-io.taig.android:toolbelt-functional_2.11:0.8.2 [S]
  ...
  | | | | +-org.typelevel:macro-compat_2.11:1.1.1 [S]
  | | | |
  | | | +-org.typelevel:machinist_2.11:0.8.2 [S]
  ...
  |     +-org.scala-lang:scala-reflect:2.11.8 [S]
  |     
  +-io.taig.android:toolbelt-graphic_2.11:0.8.2 [S]
  +-io.taig.android:toolbelt-intent_2.11:0.8.2 [S]
  +-io.taig.android:toolbelt-log_2.11:0.8.2 [S]
  +-io.taig.android:toolbelt-monix_2.11:0.8.2 [S]
  ...
  | +-io.taig.android:toolbelt-log_2.11:0.8.2 [S]
  |
  +-io.taig.android:toolbelt-resource_2.11:0.8.2 [S]
  | +-com.android.support:support-v4:25.2.0
  | | +-com.android.support:support-compat:25.2.0
  | | | +-com.android.support:support-annotations:25.2.0
  | | |
  ...
  |
  +-io.taig.android:toolbelt-system-service_2.11:0.8.2 [S]
  +-io.taig.android:toolbelt-unit_2.11:0.8.2 [S]
  +-io.taig.android:toolbelt-util_2.11:0.8.2 [S]
  +-io.taig.android:toolbelt-widget_2.11:0.8.2 [S]
