...
public abstract class MvpDialogFragment<V extends MvpView, P extends MvpPresenter<V>> extends DialogFragment
    ...
    protected DialogFragmentMvpDelegate<V, P> mvpDelegate;
     ...
     */
    @NonNull
    protected DialogFragmentMvpDelegate<V, P> getMvpDelegate() {
        if (mvpDelegate == null) {
            mvpDelegate = new DialogFragmentMvpDelegateImpl<>(this, this, true, true);
        }
    ...
    public final Dialog onCreateDialog( Bundle savedInstanceState ) {
        ...
        getMvpDelegate().onCreateDialog( savedInstanceState );
        return dialog;
    }
