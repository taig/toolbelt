...
package com.taig.android.widget.picker;
...
import com.taig.android.widget.EditText;
...
public class Number extends LinearLayout {
     ...
     */
    private final com.taig.android.widget.EditText mInputText;
    ...
    public interface OnValueChangeListener {
         ...
         */
        void onValueChange( Number picker, int oldVal, int newVal );
    }
    ...
    public interface OnScrollListener {
         ...
         *            {@link #SCROLL_STATE_IDLE}.
         */
        public void onScrollStateChange( Number view, int scrollState );
    }
     ...
     * <p>
     * If the argument is less than the {@link Number#getMinValue()} and
     * {@link Number#getWrapSelectorWheel()} is <code>false</code> the
     * current value is set to the {@link Number#getMinValue()} value.
     * </p>
     * <p>
     * If the argument is less than the {@link Number#getMinValue()} and
     * {@link Number#getWrapSelectorWheel()} is <code>true</code> the
     * current value is set to the {@link Number#getMaxValue()} value.
     * </p>
     * <p>
     * If the argument is less than the {@link Number#getMaxValue()} and
     * {@link Number#getWrapSelectorWheel()} is <code>false</code> the
     * current value is set to the {@link Number#getMaxValue()} value.
     * </p>
     * <p>
     ...
     * wrap around the {@link Number#getMinValue()} and
     * {@link Number#getMaxValue()} values.
     * <p>
    ...
    public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
        ...
        event.setClassName( Number.class.getName());
    ...
    /**
     * Posts an {@link Number.SetSelectionCommand} from the given <code>selectionStart
    ...
    class PressedStateHelper implements Runnable {
        ...
        public void cancel() {
            mMode = 0;
            mManagedButton = 0;
            Number.this.removeCallbacks(this);
            if (mIncrementVirtualButtonPressed) {
        ...
        public void buttonPressDelayed(int button) {
            ...
            Number.this.postDelayed(this, ViewConfiguration.getTapTimeout());
        }
    ...
    class AccessibilityNodeProviderImpl extends AccessibilityNodeProvider {
            ...
            switch (virtualViewId) {
                ...
                case VIRTUAL_VIEW_ID_INPUT: {
                    switch (action) {
                        case AccessibilityNodeInfo.ACTION_FOCUS: {
                            if ( Number.this.isEnabled() && !mInputText.isFocused()) {
                ...
                case VIRTUAL_VIEW_ID_INCREMENT: {
                    switch (action) {
                        case AccessibilityNodeInfo.ACTION_CLICK: {
                            if ( Number.this.isEnabled()) {
                                Number.this.changeValueByOne(true);
                                sendAccessibilityEventForVirtualView(virtualViewId,
                    ...
                    switch (action) {
                        case AccessibilityNodeInfo.ACTION_CLICK: {
                            if ( Number.this.isEnabled()) {
                                ...
                                Number.this.changeValueByOne(increment);
                                sendAccessibilityEventForVirtualView(virtualViewId,
                                        AccessibilityEvent.TYPE_VIEW_CLICKED);
                                return true;
                            }
        ...
        private void sendAccessibilityEventForVirtualText(int eventType) {
            if (((AccessibilityManager) getContext().getSystemService(Context.ACCESSIBILITY_SERVICE)).isEnabled()) {
                ...
                event.setSource( Number.this, VIRTUAL_VIEW_ID_INPUT);
                requestSendAccessibilityEvent( Number.this, event);
            }
        }
        ...
        private void sendAccessibilityEventForVirtualButton(int virtualViewId, int eventType,
            ...
            if (((AccessibilityManager) getContext().getSystemService(Context.ACCESSIBILITY_SERVICE)).isEnabled()) {
                ...
                event.setEnabled( Number.this.isEnabled());
                event.setSource( Number.this, virtualViewId );
                requestSendAccessibilityEvent( Number.this, event);
            }
        }
        ...
        private AccessibilityNodeInfo createAccessibiltyNodeInfoForInputText() {
            ...
            info.setSource( Number.this, VIRTUAL_VIEW_ID_INPUT);
        ...
        private AccessibilityNodeInfo createAccessibilityNodeInfoForVirtualButton(int virtualViewId,
            ...
            info.setSource( Number.this, virtualViewId);
            info.setParent( Number.this);
            info.setText(text);
            info.setClickable(true);
            info.setLongClickable(true);
            info.setEnabled( Number.this.isEnabled() );
        ...
        private AccessibilityNodeInfo createAccessibilityNodeInfoForNumberPicker(int left, int top,
            ...
            AccessibilityNodeInfo info = AccessibilityNodeInfo.obtain();
            info.setClassName( Number.class.getName());
            info.setPackageName( getContext().getPackageName() );
            info.setSource( Number.this);

            if (hasVirtualDecrementButton()) {
                info.addChild( Number.this, VIRTUAL_VIEW_ID_DECREMENT);
            }
            info.addChild( Number.this, VIRTUAL_VIEW_ID_INPUT);
            if (hasVirtualIncrementButton()) {
                info.addChild( Number.this, VIRTUAL_VIEW_ID_INCREMENT);
            }
